...
class KotlinFileChooserDialog(
    ...
    override fun createCenterPanel(): JComponent? {
        ...
        val field = AbstractTreeClassChooserDialog::class.java.getDeclaredField("myTree")!!
        field.isAccessible = true
        val tree = field.get(this) as Tree
    ...
    override fun createChooseByNameModel(): ChooseByNameModel {
        return GotoFileModel(this.project)
    }
}